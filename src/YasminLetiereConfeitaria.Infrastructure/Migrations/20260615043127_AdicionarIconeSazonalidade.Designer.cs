...
namespace YasminLetiereConfeitaria.Infrastructure.Migrations
{
    ...
    [Migration("20260615043127_AdicionarIconeSazonalidade")]
    partial class AdicionarIconeSazonalidade
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("YasminLetiereConfeitaria.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("22222222-2222-2222-2222-222222222222"),
                            Description = "Doce fino de nozes selecionadas trituradas, banhado em glaçúcar fondant e decorado com uma noz inteira por cima.",
                            ImageUrl = "/images/camafeu_nozes.jpg",
                            IsAvailable = true,
                        ...
                        new
                        {
                            ...
                            Description = "Camadas de creme de avelã trufado, chocolate branco Laka, brigadeiro gourmet, morangos e finalizado com Kinder Bueno.",
                            ImageUrl = "/images/kinder_cup.jpg",
                            IsAvailable = true,
                            Name = "Copo da Felicidade Kinder Bueno",
                            Price = 28.00m,
                            UpdatedAt = new DateTime(2026, 6, 15, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("22222222-2222-2222-2222-222222222222"),
                            Description = "Guirlanda decorada composta por 25 brigadeiros gourmets nos sabores tradicional belga, ninho com nutella, pistache e nozes.",
                            ImageUrl = "/images/christmas_wreath.jpg",
                            IsAvailable = true,
                            Name = "Guirlanda Festiva de Brigadeiros",
                            Price = 120.00m,
                            SeasonalTag = "Natal",
                            UpdatedAt = new DateTime(2026, 6, 15, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
